        ...
        <>
            <svg
                ...
                <g fillRule="evenodd">
                    ...
                    <path d="m18,11l-5,0l0,-5c0,-0.552 -0.448,-1 -1,-1c-0.5525,0 -1,0.448 -1,1l0,5l-5,0c-0.5525,0
            ...
            <label htmlFor="image" >
                <svg className="w-7 h-7 rounded-full p-0.5 fb-cl-main hover:bg-gray-600 flex-shrink-0"
                    height="20px" width="20px" viewBox="-1 -3 20 20">
                    <g fill="none" fillRule="evenodd">
                        <path d="M2.882 13.13C3.476 4.743 3.773.48 3.773.348L2.195.516c-.7.1-1.478.647-1.478
                     1.647l1.092 11.419c0 .5.2.9.4 1.3.4.2.7.4.9.4h.4c-.6-.6-.727-.951-.627-2.151z" fill="#0084FF">
                        </path><circle cx="8.5" cy="4.5" r="1.5" fill="#0084FF"></circle>
                        <path d="M14 6.2c-.2-.2-.6-.3-.8-.1l-2.8 2.4c-.2.1-.2.4 0
                          .6l.6.7c.2.2.2.6-.1.8-.1.1-.2.1-.4.1s-.3-.1-.4-.2L8.3 8.3c-.2-.2-.6-.3-.8-.1l-2.6
                           2-.4 3.1c0 .5.2 1.6.7 1.7l8.8.6c.2 0 .5 0 .7-.2.2-.2.5-.7.6-.9l.6-5.9L14 6.2z" fill="#0084FF">
                        </path><path d="M13.9 15.5l-8.2-.7c-.7-.1-1.3-.8-1.3-1.6l1-11.4C5.5 1 6.2.5 7
                                .5l8.2.7c.8.1 1.3.8 1.3 1.6l-1 11.4c-.1.8-.8 1.4-1.6 1.3z" strokeLinecap="round"
                            strokeLinejoin="round" stroke="#0084FF">
                        </path>
                    </g>
                </svg>
            </label>
            <svg className="w-7 h-7 rounded-full fb-cl-main p-1 hover:bg-gray-600 flex-shrink-0" height="20px" width="20px" viewBox="0 0 17 16" x="0px" y="0px">
                <g fillRule="evenodd"><circle cx="5.5" cy="5.5" fill="none" r="1"></circle><circle cx="11.5" cy="4.5" fill="none" r="1">
                </circle>
                    <path d="M5.3 9c-.2.1-.4.4-.3.7.4 1.1 1.2 1.9 2.3 2.3h.2c.2 0 .4-.1.5-.3.1-.3 0-.5-.3-.6-.8-.4-1.4-1-1.7-1.8-.1-.2-.4-.4-.7-.3z"
                        fill="none"></path><path d="M10.4 13.1c0 .9-.4 1.6-.9 2.2 4.1-1.1 6.8-5.1 6.5-9.3-.4.6-1 1.1-1.8 1.5-2 1-3.7 3.6-3.8 5.6z"
                            fill="#0084FF">
                    </path>
                    <path d="M2.5 13.4c.1.8.6 1.6 1.3 2 .5.4 1.2.6 1.8.6h.6l.4-.1c1.6-.4 2.6-1.5 2.7-2.9.1-2.4
                         2.1-5.4 4.5-6.6 1.3-.7 1.9-1.6 1.9-2.8l-.2-.9c-.1-.8-.6-1.6-1.3-2-.7-.5-1.5-.7-2.4-.5L3.6
                          1.5C1.9 1.8.7 3.4 1 5.2l1.5 8.2zm9-8.9c.6 0 1 .4 1 1s-.4 1-1 1-1-.4-1-1 .4-1 1-1zm-3.57
                           6.662c.3.1.4.4.3.6-.1.3-.3.4-.5.4h-.2c-1-.4-1.9-1.3-2.3-2.3-.1-.3.1-.6.3-.7.3-.1.5 0 .6.3.4.8 1
                            1.4 1.8 1.7zM5.5 5.5c.6 0 1 .4 1 1s-.4 1-1 1-1-.4-1-1 .4-1 1-1z" fillRule="nonzero" fill="#0084FF">
                    </path>
                </g>
            </svg>
            <svg className="w-7 h-7 rounded-full fb-cl-main p-1 hover:bg-gray-600 flex-shrink-0" height="20px" width="20px" viewBox="0 0 16 16" x="0px" y="0px">
                <path d="M.783 12.705c.4.8 1.017 1.206 1.817 1.606 0 0 1.3.594 2.5.694 1 .1 1.9.1 2.9.1s1.9 0 2.9-.1 1.679-.294
                     ...
                     2.139c0 .4-.194.8-.694.8-.5 0-.7-.3-.7-.8l-.031-5.631c0-.4.43-.696.93-.696zm-3.285.771c0-.5.3-.8.8-.8s.8.3.8.8l-.037
                      5.579c0 .4-.3.8-.8.8s-.8-.4-.8-.8l.037-5.579zm-3.192-.825c.7 0 1.307.183 1.807.683.3.3.4.7.1 1-.2.4-.7.4-1 .1-.2-.1-.5-.3-.9-.3-1 0-2.011.84-2.011
                       2.14 0 1.3.795 2.227 1.695 2.227.4 0 .805.073 1.105-.127V8.6c0-.4.3-.8.8-.8s.8.3.8.8v1.8c0 .2.037.071-.063.271-.7.7-1.57.991-2.47.991C2.868 11.662 1.3
                        10.2 1.3 8s1.704-3.623 3.504-3.623z" fillRule="nonzero" fill="#0084FF">
                </path>
            </svg>
            <form onSubmit={handleSubmit} className="w-full mx-2 relative" id="messageForm">
                <div className="w-full flex rounded-2xl bg-gray-600 p-2 ">
                    ...
                    />
                    <span onClick={() => setShowPikerEmoji(x => !x)}>
                        <svg height="20px" width="20px" viewBox="0 0 38 38">
                            <g fill="gray" fillRule="evenodd"><g transform="translate(-893.000000, -701.000000)">
                                <g transform="translate(709.000000, 314.000000)">
                                    <g>
                                        <path d="M210.5,405 C209.121,405 208,403.879 208,402.5 C208,401.121
                ...
                <GEmoji onPickEmoji={e => handlePickEmoji(e)} isOpen={showPikerEmoji} setOpen={e=>setShowPikerEmoji(e)} />
            </form>
            {message ?
                <button type="submit" className="flex-shrink-0 rounded-full w-9 h-9 bg-opacity-0 cursor-pointer hover:bg-gray-600 p-2 focus:outline-none" form="messageForm">
                    <svg className="crt8y2ji" height="20px" width="20px" viewBox="0 0 24 24">
                ...
                <button type="submit" className="flex-shrink-0 rounded-full w-9 h-9 bg-opacity-0 cursor-pointer hover:bg-gray-600 p-1 focus:outline-none" form="messageForm">
                    <LikeFacebook />
                </button>
            }
        </>
